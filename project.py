        ...
        def Login_user():
            if usernameEntry.get() == '' or password.get() == '':
                ...
                if row == None:
                    ...
                    Button_3 = Button(airline, text='Cancel flights', font=('monotype 12 bold'), bg='white', fg='black',
...
def insert_flight():
    ...
    FseatsLabel = Label(window, text="Filled seats ", font=("Open sans", 15), fg='black', bg='white', width=20,bd=2)
